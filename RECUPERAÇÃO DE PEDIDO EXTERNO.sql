--- RECUPERAÇÃO DE PEDIDO EXTERNO DA TABELA VENDAS_LOTE_COPIA_PEDIDO E VENDAS_LOTE_PROD_COPIA_PEDIDO
INSERT INTO VENDAS_LOTE ([PEDIDO_EXTERNO]
      ,[TIPO_DO_DIGITADOR]
      ,[MOEDA]
      ,[CODIGO_TAB_PRECO]
      ,[TIPO]
...
SELECT [PEDIDO_EXTERNO]
      ...
      ,[DESCONTO_COND_PGTO]
      ,[PORC_ENCARGO]
 from VENDAS_LOTE_COPIA_PEDIDO
WHERE PEDIDO_EXTERNO='0031c.001412'


INSERT INTO VENDAS_LOTE_PROD (PRODUTO
      ,COR_PRODUTO
      ,ENTREGA
      ,PEDIDO_EXTERNO
...
SELECT [PRODUTO]
      ...
      ,[COMISSAO_VALOR_GERENTE]
      ,[COMISSAO_VALOR]
 from VENDAS_LOTE_PROD_COPIA_PEDIDO
WHERE PEDIDO_EXTERNO='0031c.001412'
