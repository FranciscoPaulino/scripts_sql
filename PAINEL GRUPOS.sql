SELECT DESC_SETOR_PRODUCAO=SUBSTRING(COSTURA.DESC_SETOR_PRODUCAO,9,10),COSTURA.DESC_RECURSO,PRODUCAO_ORDEM.PRODUTO,PRODUCAO_ORDEM_COR.COR_PRODUTO,PRODUCAO_TAREFAS.RECURSO_PRODUTIVO, PRODUCAO_TAREFAS.ORDEM_PRODUCAO, PRODUCAO_ORDEM.PRIORIDADE, 
