...
CREATE TABLE Contador(
	Id_Contador INT IDENTITY PRIMARY KEY, 
...
CREATE TABLE [dbo].[Registro_Contador](
	...
	[Valor] [int] NULL,
	CONSTRAINT FK01_Registro_Contador FOREIGN KEY (Id_Contador) REFERENCES Contador(Id_Contador)
) ON [PRIMARY]
...
exec stpCarga_ContadoresSQL

SELECT Dt_Log, Nm_Contador, Valor
FROM Registro_Contador A
JOIN Contador B ON A.Id_Contador = B.Id_Contador
ORDER BY Nm_Contador, Dt_Log
