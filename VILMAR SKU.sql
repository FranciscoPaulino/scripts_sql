...
AND (VENDAS.cliente_atacado LIKE '%PINTOS%' or VENDAS.cliente_atacado LIKE '%MEGA%' or VENDAS.cliente_atacado LIKE '%nazare%' OR 
VENDAS.cliente_atacado LIKE '%SUPERMERCADO IDEAL%' or VENDAS.cliente_atacado LIKE '%G%BARBOSA%CENCOSUD%') 
