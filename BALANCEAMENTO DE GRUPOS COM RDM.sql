...
RECEBIMENTO.RECURSO_PRODUTIVO,RECEBIMENTO.DESC_SETOR_PRODUCAO,GRUPO=COSTURA.RECURSO_PRODUTIVO,RECEBIMENTO.QTDE_S,RECEBIMENTO.GRADE,RECEBIMENTO.TAMANHO,DESC_PROPRIEDADE,VALOR_PROPRIEDADE 
FROM (
...
PRODUCAO_FASE.FASE_PRODUCAO IN('001','002','003','004','004.1','005','006','006.1','007') --AND PRODUCAO_TAREFAS.ORDEM_PRODUCAO='56059'
...
JOIN (SELECT DESC_PROPRIEDADE,VALOR_PROPRIEDADE,PRODUTO FROM PROPRIEDADE 
JOIN PROP_PRODUTOS ON PROP_PRODUTOS.PROPRIEDADE=PROPRIEDADE.PROPRIEDADE
WHERE PROP_PRODUTOS.PROPRIEDADE IN ('10043','10044','10045')) PROP_PRODUTOS ON PROP_PRODUTOS.PRODUTO=COSTURA.PRODUTO
...
QTDE_OPERADOR=ISNULL(OPERADORES.QTDE_OPERADOR,0),MINUTOS_DISPONIVEIS=ISNULL(OPERADORES.MINUTOS_DISPONIVEIS,0),TEMPO_CRONOMETRADO=ISNULL(TEMPO_PADRAO.TEMPO_CRONOMETRADO,0),
RECEBIMENTO.PRODUTO,RECEBIMENTO.COR_PRODUTO,RECEBIMENTO.ORDEM_PRODUCAO,
RECEBIMENTO.RECURSO_PRODUTIVO,RECEBIMENTO.DESC_SETOR_PRODUCAO,GRUPO=COSTURA.RECURSO_PRODUTIVO,RECEBIMENTO.QTDE_S,RECEBIMENTO.GRADE,RECEBIMENTO.TAMANHO,COSTURA.MATERIAL,MATERIAIS.DESC_MATERIAL 
FROM (
...
SELECT PRODUTOS.MATERIAL,PRODUTOS.PRODUTO,PRODUCAO_TAREFAS.ORDEM_PRODUCAO,PRODUCAO_TAREFAS.RECURSO_PRODUTIVO,PRODUCAO_RECURSOS.DESC_RECURSO,PRODUCAO_SETOR.DESC_SETOR_PRODUCAO
FROM dbo.PRODUCAO_FASE PRODUCAO_FASE, dbo.PRODUCAO_RECURSOS PRODUCAO_RECURSOS, dbo.PRODUCAO_SETOR PRODUCAO_SETOR, dbo.PRODUCAO_TAREFAS PRODUCAO_TAREFAS, dbo.PRODUTOS PRODUTOS, dbo.PRODUCAO_ORDEM
WHERE PRODUCAO_FASE.FASE_PRODUCAO = PRODUCAO_TAREFAS.FASE_PRODUCAO AND 
PRODUCAO_FASE.FASE_PRODUCAO = PRODUCAO_SETOR.FASE_PRODUCAO AND 
PRODUCAO_RECURSOS.RECURSO_PRODUTIVO = PRODUCAO_TAREFAS.RECURSO_PRODUTIVO AND 
...
LEFT JOIN MATERIAIS ON MATERIAIS.MATERIAL=COSTURA.MATERIAL
