...
FROM OPENROWSET(BULK N'c:\temp\xml\23170100119633000113550560000275411015877134-procNFe.xml', SINGLE_BLOB) -- Informe onde se encontra o arquivo XML
AS Arquivo)
...
SET @XML = (
SELECT CAST(BulkColumn AS XML)
FROM OPENROWSET(BULK N'C:\TEMP\XML\23170100119633000113550560000275411015877134-procNFe.xml', SINGLE_BLOB) -- Informe onde se encontra o arquivo XML
AS Arquivo)
...
where a.chNFe='23170100119633000113550560000275411015877134' 
